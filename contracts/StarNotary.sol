...
contract StarNotary is ERC721 {
    ...
    string constant public name = "Stareum";
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        bool senderIsAnOwner = msg.sender == owner1 || msg.sender == owner2;
        require(senderIsAnOwner,"You can't exchange with out being an owner address holder!!");
