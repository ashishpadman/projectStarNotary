...
it("can add the star name and star symbol properly", async () => {
  ...
  assert.equal(await instance.name.call(), "Stareum");
...
it("lets 2 users exchange stars", async () => {
  ...
  await instance.createStar("Owner1 Star!", tokenId1, { from: owner1 });
  await instance.createStar("Owner2 Star!", tokenId2, { from: owner2 });
...
it("lets a user transfer a star", async () => {
  ...
  await instance.createStar("Give away Star!", tokenId, { from: sender });
